            ...
            if (userWithSameEmail == null)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (await _featureManager.IsEnabledAsync(nameof(FeatureManagement.EnableEmailService)))
                    {
                        ...
                        var email = new MailRequest() { ToEmail = "rkaabicakci@gmail.com", Body = $"Please confirm your account by visiting this URL {verificationUri}", Subject = "Confirm Registration" };
